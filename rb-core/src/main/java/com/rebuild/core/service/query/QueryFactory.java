...
import com.rebuild.core.privileges.impl.RoleBaseQueryFilter;
...
public class QueryFactory {
	...
	@Autowired
	protected QueryFactory(PersistManagerFactory factory) {
	...
	public Query createQuery(String ajql, Filter filter) {
		...
		Query query = factory.createQuery(ajql)
	...
	public NativeQuery createNativeQuery(String sql) {
		return factory.createNativeQuery(sql)
				.setTimeout(QUERY_TIMEOUT)
				.setSlowLoggerTime(SLOW_LOGGER_TIME);
	}
