...
import com.rebuild.core.helper.language.LanguageBundle;
...
public class LanguagesControll extends BaseController {
    ...
    public static boolean switchLanguage(HttpServletRequest request) {
        ...
        String storeLocale = RebuildApplication.getSessionStore().getLocale();
