            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="text-break announcement-contents"
                             dangerouslySetInnerHTML={{__html: contentHtml}}/>
                        <div>
                            <span
                                className="float-left text-muted">由 {this.props.publishBy} 发布于 {this.props.publishOn}</span>
                            <span className="float-right"><a
                                href={`${rb.baseUrl}/app/list-and-view?id=${this.props.id}`}>前往动态查看</a></span>
...
var $showAnnouncement = function () {
    $.get('/commons/announcements', (res) => {
        ...
        const as = res.data.map((item, idx) => {
            return <div className="bg-warning" key={'a-' + idx} title="查看详情"
