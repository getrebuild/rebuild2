...
const editMode = function () {
    $('.syscfg table td[data-id]').each(function () {
        ...
        if (options) {
            ...
            const comp = <select name={name} className="form-control form-control-sm" onChange={changeValue}
            ...
            renderRbcomp(<input defaultValue={val} name={name} className="form-control form-control-sm"
