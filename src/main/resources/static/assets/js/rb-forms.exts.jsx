    ...
    renderElement() {
      ...
      <span title={this.props.readonly ? null : '选择头像'}>
        ...
        <input ref={(c) => this._fieldValue__input = c} type="file" className="inputfile"
               id={`${this.props.field}-input`} accept="image/png,image/jpeg,image/gif" data-maxsize="10240000"/>
        }
          <label htmlFor={`${this.props.field}-input`} className="img-thumbnail img-upload"><img src={aUrl}
                                                                                                 alt="头像"/></label>
      </span>
        </div>
    }
