...
$(document).ready(() => {
    ...
    $('.J_filter').click(() => {
        renderRbcomp(<AdvFilter title="设置过滤条件" entity={wpc.sourceEntity} filter={esourceFilter} inModal={true}
                                confirm={saveFilter} canNoFilters={true}/>)
    })
...
const add_axis = ((target, axis) => {
    ...
    const aopts = $dropdown.find('.dropdown-menu .dropdown-item').click(function () {
        ...
        if (calc) {
            ...
            else renderRbcomp(<DlgAxisProps {...state} />, null, function () {
                dlgAxisProps = this
            })
        }
    })
...
const render_preview = (() => {
    $setTimeout(() => {
        ...
        if (c) renderRbcomp(c, 'chart-preview', function () {
                ...
                <div className="form">
                    <div className="form-group row">
                        ...
                        <div className="col-sm-7">
                            <input className="form-control form-control-sm" placeholder="默认" data-id="label"
                    ...
                    {this.state.isNumAxis !== true ? null :
                        <div className="form-group row">
                            ...
                            <div className="col-sm-7">
                                <select className="form-control form-control-sm" value={this.state.scale || 2}
                                        data-id="scale" onChange={this.handleChange}>
                    ...
                    <div className="form-group row footer">
                        <div className="col-sm-7 offset-sm-3">
                            <button className="btn btn-primary btn-space" type="button"
                                    onClick={() => this.saveProps()}>确定
                            </button>
