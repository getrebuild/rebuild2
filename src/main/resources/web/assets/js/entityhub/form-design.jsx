...
const render_item = function (data) {
    ...
    if (data.displayType) {
        ...
        $('<a class="rowspan mr-1" title="单列/双列"><i class="zmdi zmdi-unfold-more"></i></a>').appendTo(action).click(function () {
        ...
        return (
            <form className="field-attr">
                <div className="form-group">
                    <label>填写提示</label>
                    <input type="text" className="form-control form-control-sm" name="fieldTips"
                           value={this.state.fieldTips || ''} onChange={this.handleChange} placeholder="输入填写提示"/>
                </div>
                <div className="form-group">
                    <label>字段名称 <span>(部分内建字段不能修改)</span></label>
                    <input type="text" className="form-control form-control-sm" name="fieldLabel"
                           value={this.state.fieldLabel || ''} onChange={this.handleChange}
    ...
    renderContent() {
        return (
            <form className="field-attr">
                <div className="form-group">
                    <label>分栏名称</label>
                    <input type="text" className="form-control form-control-sm" name="dividerName"
                           value={this.state.dividerName || ''} onChange={this.handleChange} placeholder="输入分栏名称"/>
                </div>
                <div className="form-group mb-1">
                    <button type="button" className="btn btn-space btn-primary" onClick={this.confirm}>确定</button>
                </div>
