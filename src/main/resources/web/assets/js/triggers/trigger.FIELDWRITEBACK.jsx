                    ...
                    <div className="col-md-12 col-lg-9">
                            ...
                            {(!this.state.items || this.state.items.length === 0) ? null : this.state.items.map((item) => {
                                return <div key={'item-' + item.targetField}>
                                    <div className="row">
                                        <div className="col-5">
                                            <span
                                                className="badge badge-warning">{this.__fieldLabel(this.__targetFieldsCache, item.targetField)}</span>
                                        </div>
                                        <div className="col-5 del-wrap">
                                            <span className="zmdi zmdi-forward zmdi-hc-rotate-180"></span>
                                            <span
                                                className="badge badge-warning">{this.__fieldLabel(this.state.sourceFields, item.sourceField)}</span>
                        ...
                        <div className="row">
                            ...
                            <div className="col-2 pl-0" style={{marginLeft: -13}}>
                                <button type="button" ref={(c) => this._btnDateExpr = c} title="日期公式"
                                        className="btn btn-secondary mw-auto" onClick={(e) => this._showDateExpr(e)}>
                ...
                <div className="form-group">
                    ...
                    <div className="input-group">
                        ...
                        <input type="number" min="1" max="999999" className="form-control form-control-sm ml-1"
                               defaultValue="1" ref={(c) => this._refs[2] = c}/>
