...
$(document).ready(function () {
    $('.J_vcode-btn').click(function () {
        ...
        if (!email) {
            RbHighbar.create($lang('InputPls', 'Email'));
            return
        }
    ...
    $('.J_confirm-btn').click(function () {
        let fullName = $val('#sFullName'),
            ...
            vcode = $val('#sVcode')
        if (!fullName) {
            RbHighbar.create($lang('InputPls', 'FullName'));
            return
        }
        if (!name) {
            RbHighbar.create($lang('InputPls', 'Username'));
            return
        }
        if (!email) {
            RbHighbar.create($lang('InputPls', 'Email'));
        ...
        if (!vcode) {
            RbHighbar.create($lang('InputPls', 'Vcode'));
            return
        }
