                ...
                <div className="form">
                    <div className="form-group row">
                        ...
                        <div className="col-sm-7">
                            <a className="project-icon" title="选择图标" onClick={() => this._selectIcon()}><i
                                className={`icon zmdi zmdi-${this.state.iconName || 'texture'}`}></i></a>
                        </div>
                    </div>
                    <div className="form-group row">
                        <label className="col-sm-3 col-form-label text-sm-right">项目名称</label>
                        <div className="col-sm-7">
                            <input className="form-control form-control-sm" value={this.state.projectName || ''}
                                   data-id="projectName" onChange={this.handleChange} maxLength="60"/>
                        </div>
                    </div>
                    {!this.props.id && (
                        <React.Fragment>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-7">
                                    <input className="form-control form-control-sm "
                                           value={this.state.projectCode || ''} data-id="projectCode"
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-7">
                                    <label
                                        ...
                                        <input className="custom-control-input" type="checkbox" value="1" defaultChecked
                                               ref={(c) => this._useTemplate = c}/>
