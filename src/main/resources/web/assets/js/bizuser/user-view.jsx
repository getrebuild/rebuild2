        ...
        $.get(`/admin/bizuser/check-user-status?id=${userId}`, (res) => {
            ...
            if (res.data.disabled === true) {
                ...
                if (!res.data.role || !res.data.dept) {
                    $('.J_enable').off('click').click(() => renderRbcomp(<DlgEnableUser enable={true} user={userId}
                                                                                        dept={!res.data.dept}
                                                                                        role={!res.data.role}/>))
                }
            } else {
            ...
            <div className="form">
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-7">
                        <UserSelector hideUser={true} hideRole={true} hideTeam={true} multiple={false}
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-7">
                        <UserSelector hideUser={true} hideDepartment={true} hideTeam={true} multiple={false}
